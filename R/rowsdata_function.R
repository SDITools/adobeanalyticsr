...
apply_rowsdata <- function(i, resn, prefinalnames, dat)  {
  rowsdata <- function(it, i) {
    ...
    if(i == 16) {
      if(resn[[it]]$numberOfElements != 0) {
        tf <- resn[[it]]$rows %>% dplyr::mutate(!!prefinalnames[[15]][[1]] := dat[[1]][it],
                                                !!prefinalnames[[15]][[2]] := dat[[2]][it],
                                                !!prefinalnames[[14]][[1]] := dat[[3]][it],
                                                !!prefinalnames[[14]][[2]] := dat[[4]][it],
                                                !!prefinalnames[[13]][[1]] := dat[[5]][it],
                                                !!prefinalnames[[13]][[2]] := dat[[6]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[7]][it],
                                                !!prefinalnames[[12]][[2]] := dat[[8]][it],
                                                !!prefinalnames[[11]][[1]] := dat[[9]][it],
                                                !!prefinalnames[[11]][[2]] := dat[[10]][it],
                                                !!prefinalnames[[10]][[1]] := dat[[11]][it],
                                                !!prefinalnames[[10]][[2]] := dat[[12]][it],
                                                !!prefinalnames[[9]][[1]] := dat[[13]][it],
                                                !!prefinalnames[[9]][[2]] := dat[[14]][it],
                                                !!prefinalnames[[8]][[1]] := dat[[15]][it],
                                                !!prefinalnames[[8]][[2]] := dat[[16]][it],
                                                !!prefinalnames[[7]][[1]] := dat[[17]][it],
                                                !!prefinalnames[[7]][[2]] := dat[[18]][it],
                                                !!prefinalnames[[6]][[1]] := dat[[19]][it],
                                                !!prefinalnames[[6]][[2]] := dat[[20]][it],
                                                !!prefinalnames[[5]][[1]] := dat[[21]][it],
                                                !!prefinalnames[[5]][[2]] := dat[[22]][it],
                                                !!prefinalnames[[4]][[1]] := dat[[23]][it],
                                                !!prefinalnames[[4]][[2]] := dat[[24]][it],
                                                !!prefinalnames[[3]][[1]] := dat[[25]][it],
                                                !!prefinalnames[[3]][[2]] := dat[[26]][it],
                                                !!prefinalnames[[2]][[1]] := dat[[27]][it],
                                                !!prefinalnames[[2]][[2]] := dat[[28]][it],
                                                !!prefinalnames[[1]][[1]] := dat[[29]][it],
                                                !!prefinalnames[[1]][[2]] := dat[[30]][it])
        return(tf)
      }
    }
    if(i == 17) {
      if(resn[[it]]$numberOfElements != 0) {
        tf <- resn[[it]]$rows %>% dplyr::mutate(!!prefinalnames[[16]][[1]] := dat[[1]][it],
                                                !!prefinalnames[[16]][[2]] := dat[[2]][it],
                                                !!prefinalnames[[15]][[1]] := dat[[3]][it],
                                                !!prefinalnames[[15]][[2]] := dat[[4]][it],
                                                !!prefinalnames[[14]][[1]] := dat[[5]][it],
                                                !!prefinalnames[[14]][[2]] := dat[[6]][it],
                                                !!prefinalnames[[13]][[1]] := dat[[7]][it],
                                                !!prefinalnames[[13]][[2]] := dat[[8]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[9]][it],
                                                !!prefinalnames[[12]][[2]] := dat[[10]][it],
                                                !!prefinalnames[[11]][[1]] := dat[[11]][it],
                                                !!prefinalnames[[11]][[2]] := dat[[12]][it],
                                                !!prefinalnames[[10]][[1]] := dat[[13]][it],
                                                !!prefinalnames[[10]][[2]] := dat[[14]][it],
                                                !!prefinalnames[[9]][[1]] := dat[[15]][it],
                                                !!prefinalnames[[9]][[2]] := dat[[16]][it],
                                                !!prefinalnames[[8]][[1]] := dat[[17]][it],
                                                !!prefinalnames[[8]][[2]] := dat[[18]][it],
                                                !!prefinalnames[[7]][[1]] := dat[[19]][it],
                                                !!prefinalnames[[7]][[2]] := dat[[20]][it],
                                                !!prefinalnames[[6]][[1]] := dat[[21]][it],
                                                !!prefinalnames[[6]][[2]] := dat[[22]][it],
                                                !!prefinalnames[[5]][[1]] := dat[[23]][it],
                                                !!prefinalnames[[5]][[2]] := dat[[24]][it],
                                                !!prefinalnames[[4]][[1]] := dat[[25]][it],
                                                !!prefinalnames[[4]][[2]] := dat[[26]][it],
                                                !!prefinalnames[[3]][[1]] := dat[[27]][it],
                                                !!prefinalnames[[3]][[2]] := dat[[28]][it],
                                                !!prefinalnames[[2]][[1]] := dat[[29]][it],
                                                !!prefinalnames[[2]][[2]] := dat[[30]][it],
                                                !!prefinalnames[[1]][[1]] := dat[[31]][it],
                                                !!prefinalnames[[1]][[2]] := dat[[32]][it])
        return(tf)
      }
    }
    if(i == 18) {
      if(resn[[it]]$numberOfElements != 0) {
        tf <- resn[[it]]$rows %>% dplyr::mutate(!!prefinalnames[[17]][[1]] := dat[[1]][it],
                                                !!prefinalnames[[17]][[2]] := dat[[2]][it],
                                                !!prefinalnames[[16]][[1]] := dat[[3]][it],
                                                !!prefinalnames[[16]][[2]] := dat[[4]][it],
                                                !!prefinalnames[[15]][[1]] := dat[[5]][it],
                                                !!prefinalnames[[15]][[2]] := dat[[6]][it],
                                                !!prefinalnames[[14]][[1]] := dat[[7]][it],
                                                !!prefinalnames[[14]][[2]] := dat[[8]][it],
                                                !!prefinalnames[[13]][[1]] := dat[[9]][it],
                                                !!prefinalnames[[13]][[2]] := dat[[10]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[11]][it],
                                                !!prefinalnames[[12]][[2]] := dat[[12]][it],
                                                !!prefinalnames[[11]][[1]] := dat[[13]][it],
                                                !!prefinalnames[[11]][[2]] := dat[[14]][it],
                                                !!prefinalnames[[10]][[1]] := dat[[15]][it],
                                                !!prefinalnames[[10]][[2]] := dat[[16]][it],
                                                !!prefinalnames[[9]][[1]] := dat[[17]][it],
                                                !!prefinalnames[[9]][[2]] := dat[[18]][it],
                                                !!prefinalnames[[8]][[1]] := dat[[19]][it],
                                                !!prefinalnames[[8]][[2]] := dat[[20]][it],
                                                !!prefinalnames[[7]][[1]] := dat[[21]][it],
                                                !!prefinalnames[[7]][[2]] := dat[[22]][it],
                                                !!prefinalnames[[6]][[1]] := dat[[23]][it],
                                                !!prefinalnames[[6]][[2]] := dat[[24]][it],
                                                !!prefinalnames[[5]][[1]] := dat[[25]][it],
                                                !!prefinalnames[[5]][[2]] := dat[[26]][it],
                                                !!prefinalnames[[4]][[1]] := dat[[27]][it],
                                                !!prefinalnames[[4]][[2]] := dat[[28]][it],
                                                !!prefinalnames[[3]][[1]] := dat[[29]][it],
                                                !!prefinalnames[[3]][[2]] := dat[[30]][it],
                                                !!prefinalnames[[2]][[1]] := dat[[31]][it],
                                                !!prefinalnames[[2]][[2]] := dat[[32]][it],
                                                !!prefinalnames[[1]][[1]] := dat[[33]][it],
                                                !!prefinalnames[[1]][[2]] := dat[[34]][it])
        return(tf)
      }
    }
    if(i == 19) {
      if(resn[[it]]$numberOfElements != 0) {
        tf <- resn[[it]]$rows %>% dplyr::mutate(!!prefinalnames[[18]][[1]] := dat[[1]][it],
                                                !!prefinalnames[[18]][[2]] := dat[[2]][it],
                                                !!prefinalnames[[17]][[1]] := dat[[3]][it],
                                                !!prefinalnames[[17]][[2]] := dat[[4]][it],
                                                !!prefinalnames[[16]][[1]] := dat[[5]][it],
                                                !!prefinalnames[[16]][[2]] := dat[[6]][it],
                                                !!prefinalnames[[15]][[1]] := dat[[7]][it],
                                                !!prefinalnames[[15]][[2]] := dat[[8]][it],
                                                !!prefinalnames[[14]][[1]] := dat[[9]][it],
                                                !!prefinalnames[[14]][[2]] := dat[[10]][it],
                                                !!prefinalnames[[13]][[1]] := dat[[11]][it],
                                                !!prefinalnames[[13]][[2]] := dat[[12]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[13]][it],
                                                !!prefinalnames[[12]][[2]] := dat[[14]][it],
                                                !!prefinalnames[[11]][[1]] := dat[[15]][it],
                                                !!prefinalnames[[11]][[2]] := dat[[16]][it],
                                                !!prefinalnames[[10]][[1]] := dat[[17]][it],
                                                !!prefinalnames[[10]][[2]] := dat[[18]][it],
                                                !!prefinalnames[[9]][[1]] := dat[[19]][it],
                                                !!prefinalnames[[9]][[2]] := dat[[20]][it],
                                                !!prefinalnames[[8]][[1]] := dat[[21]][it],
                                                !!prefinalnames[[8]][[2]] := dat[[22]][it],
                                                !!prefinalnames[[7]][[1]] := dat[[23]][it],
                                                !!prefinalnames[[7]][[2]] := dat[[24]][it],
                                                !!prefinalnames[[6]][[1]] := dat[[25]][it],
                                                !!prefinalnames[[6]][[2]] := dat[[26]][it],
                                                !!prefinalnames[[5]][[1]] := dat[[27]][it],
                                                !!prefinalnames[[5]][[2]] := dat[[28]][it],
                                                !!prefinalnames[[4]][[1]] := dat[[29]][it],
                                                !!prefinalnames[[4]][[2]] := dat[[30]][it],
                                                !!prefinalnames[[3]][[1]] := dat[[31]][it],
                                                !!prefinalnames[[3]][[2]] := dat[[32]][it],
                                                !!prefinalnames[[2]][[1]] := dat[[33]][it],
                                                !!prefinalnames[[2]][[2]] := dat[[34]][it],
                                                !!prefinalnames[[1]][[1]] := dat[[35]][it],
                                                !!prefinalnames[[1]][[2]] := dat[[36]][it])
        return(tf)
      }
    }
    if(i == 20) {
      if(resn[[it]]$numberOfElements != 0) {
        tf <- resn[[it]]$rows %>% dplyr::mutate(!!prefinalnames[[19]][[1]] := dat[[1]][it],
                                                !!prefinalnames[[19]][[2]] := dat[[2]][it],
                                                !!prefinalnames[[18]][[1]] := dat[[3]][it],
                                                !!prefinalnames[[18]][[2]] := dat[[4]][it],
                                                !!prefinalnames[[17]][[1]] := dat[[5]][it],
                                                !!prefinalnames[[17]][[2]] := dat[[6]][it],
                                                !!prefinalnames[[16]][[1]] := dat[[7]][it],
                                                !!prefinalnames[[16]][[2]] := dat[[8]][it],
                                                !!prefinalnames[[15]][[1]] := dat[[9]][it],
                                                !!prefinalnames[[15]][[2]] := dat[[10]][it],
                                                !!prefinalnames[[14]][[1]] := dat[[11]][it],
                                                !!prefinalnames[[14]][[2]] := dat[[12]][it],
                                                !!prefinalnames[[13]][[1]] := dat[[13]][it],
                                                !!prefinalnames[[13]][[2]] := dat[[14]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[15]][it],
                                                !!prefinalnames[[12]][[2]] := dat[[16]][it],
                                                !!prefinalnames[[12]][[1]] := dat[[17]][it],
                                                !!prefinalnames[[11]][[2]] := dat[[18]][it],
                                                !!prefinalnames[[10]][[1]] := dat[[19]][it],
                                                !!prefinalnames[[10]][[2]] := dat[[20]][it],
                                                !!prefinalnames[[9]][[1]] := dat[[21]][it],
                                                !!prefinalnames[[9]][[2]] := dat[[22]][it],
                                                !!prefinalnames[[8]][[1]] := dat[[23]][it],
                                                !!prefinalnames[[8]][[2]] := dat[[24]][it],
                                                !!prefinalnames[[7]][[1]] := dat[[25]][it],
                                                !!prefinalnames[[7]][[2]] := dat[[26]][it],
                                                !!prefinalnames[[6]][[1]] := dat[[27]][it],
                                                !!prefinalnames[[6]][[2]] := dat[[28]][it],
                                                !!prefinalnames[[5]][[1]] := dat[[29]][it],
                                                !!prefinalnames[[5]][[2]] := dat[[30]][it],
                                                !!prefinalnames[[4]][[1]] := dat[[31]][it],
                                                !!prefinalnames[[4]][[2]] := dat[[32]][it],
                                                !!prefinalnames[[3]][[1]] := dat[[33]][it],
                                                !!prefinalnames[[3]][[2]] := dat[[34]][it],
                                                !!prefinalnames[[2]][[1]] := dat[[35]][it],
                                                !!prefinalnames[[2]][[2]] := dat[[36]][it],
                                                !!prefinalnames[[1]][[1]] := dat[[37]][it],
                                                !!prefinalnames[[1]][[2]] := dat[[38]][it])
        return(tf)
      }
    }
  }
