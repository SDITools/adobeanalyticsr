...
#'
#' @param definition The project definition json string
...
#' @export
#'
proj_build <- function(defintion = NULL,
                       expansion = NULL,
                       locale = 'en_US',
                       debug = FALSE,
  ...
  res <- aw_call_data(req_path = urlstructure, body = definition, debug = debug, company_id = company_id)
